...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/Khudalagse-logom2.png" alt="logo-img"> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/background.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Your Favorite Food delivery Partner in Mirpur Area</h5>
...
<div class="flex flex-col md:flex-row items-center bg-gray-200 px-4 py-2 justify-between rounded-sm" style="font-size: 1rem; color: black;">
<h5 class="mb-2 md:mb-0 mr-0 md:mr-2 text-center md:text-left" style="color: white;">Find Nearest Restaurants to your Location</h5>

    <input type="text" id="locationInput" class="border border-gray-300 px-3 py-2 rounded-md focus:outline-none mb-2 md:mb-0" placeholder="Enter your address" onmouseover="getLocation()">
    <button id="getLocationBtn" class="btn btn-danger" onclick="getLocation()">
        <i class="fas fa-map-marker-alt"></i> Get Your Location
    </button>
</div>
...
<div id="mapContainer" style="position: relative; height: 400px; display: none;"></div>
<button id="saveLocationBtn" class="btn btn-success mt-2" style="display: none;">Save Location</button>
