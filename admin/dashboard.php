            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="images/Khudalagse-logom.png" alt="Khudalagse" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text
                        <span><img src="images/Khudalagse-logom.png" alt="homepage" class="dark-logo" /></span>
                    </a> -->
                </div>
                <!-- End Logo -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-exchange" aria-hidden="true"></i><span class="hide-menu">Payments</span></a>
                            <ul aria-expanded="false" class="collapse">
                ...
                <!-- Start Page Content -->
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span><i class="fa fa-exchange f-s-40" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
